...
class Settings(BaseSettings):
    ...
    # Object storage for documents (e.g., Aliyun OSS)
    use_oss_storage: bool = Field(default=False, description="Store source documents in OSS bucket instead of local disk")
    oss_endpoint: Optional[str] = Field(default=None, description="OSS endpoint, e.g., oss-cn-hangzhou.aliyuncs.com")
    oss_internal_endpoint: Optional[str] = Field(default=None, description="Optional internal endpoint for ECS/同地域访问")
    ...
    oss_prefix: str = Field(default="docs", description="Key prefix/folder used to store documents inside bucket")
